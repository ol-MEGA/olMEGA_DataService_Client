...
Version 1.2 JB correct calibration for IHAB data
...
histogram_filename = f"Histo_Results_EM1_PsychoAcousticM_{pre_analysis_time_in_min}min_study_{study}_{start_survey}_{end_survey}"
if end_survey == -1:
    histogram_filename = f"Histo_Results_EM1_PsychoAcousticM_{pre_analysis_time_in_min}min_study_{study}_{start_survey}_end"
