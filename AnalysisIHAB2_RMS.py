...
result_filename = f"Results_EM1_{weighting_func}_weighting_{pre_analysis_time_in_min}min_study_{study}_{start_survey}_{end_survey}"
histogram_filename = f"Histo_Results_EM1__{weighting_func}_weighting_{pre_analysis_time_in_min}min_study_{study}_{start_survey}_{end_survey}"
if end_survey == -1:
    result_filename = f"Results_EM1__{weighting_func}_weighting_{pre_analysis_time_in_min}min_study_{study}_{start_survey}_end"
    histogram_filename = f"Histo_Results_EM1__{weighting_func}_weighting_{pre_analysis_time_in_min}min_study_{study}_{start_survey}_end"
...
#all_participants = get_all_participants_for_study(client, study)


all_questionaires = get_all_questionaire_infos_for_study(client, study)    
