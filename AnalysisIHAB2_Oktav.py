...
histogram_filename = f"Histo_Results_EM1_OctavLevel_{pre_analysis_time_in_min}min_study_{study}_{start_survey}_{end_survey}"
if end_survey == -1:
#    result_filename = f"Results_EM1_OctavLevel{start_survey}_end"
    histogram_filename = f"Histo_Results_EM1_OctavLevel_{pre_analysis_time_in_min}min_study_{study}_{start_survey}_end"
